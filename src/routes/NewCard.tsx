...
const NewCard = () => {
    ...
    const createCard = (data: CreateCard) => axios.post(url, data, {
        headers: {
    ...
    const onSubmit = (formData: CreateCard) => {

        createCard(formData)
            .then(() => {
                toast.success("Card Create Success!", { position: "top-center", autoClose: 2000 });
                setTimeout(() => {
                    navigate("/");
                }, 2500);
            })
            .catch((error) => {
                ...
                toast.error("Failed to create card", { position: "top-center", autoClose: 2000 });
            });
    }

    return (
        <>
            <h1 className="flex justify-center text-blue-600 text-3xl mt-10">CREATE CARD</h1>
            <div className="divForm flex justify-center mt-5">
                ...
                <form noValidate onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <button id="form-new-card-button" type="submit" className="bg-blue-400 border border-black rounded-md my-5">Create new Card</button>
                </form>
